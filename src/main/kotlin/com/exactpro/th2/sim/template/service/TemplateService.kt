...
import com.exactpro.th2.sim.template.rule.TemplateNewOrderSingleRule
...
class TemplateService : SimTemplateGrpc.SimTemplateImplBase(), ISimulatorPart {
    ...
    override fun createDemoRule(request: TemplateFixRuleCreate, responseObserver: StreamObserver<RuleID>?) {
        ...
        ServiceUtils.addRule(TemplateNewOrderSingleRule(request.fieldsMap), request.connectionId.sessionAlias, simulator, responseObserver)
    }
